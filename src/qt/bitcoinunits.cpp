...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("WAYF");
    case mBTC: return QString("mWAYF");
    case uBTC: return QString::fromUtf8("μWAYF");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("Wayfcoins");
    case mBTC: return QString("Milli-Wayfcoins (1 / 1,000)");
    case uBTC: return QString("Micro-Wayfcoins (1 / 1,000,000)");
    default: return QString("???");
    }
}
